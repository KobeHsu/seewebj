(function ( $ ) {
	...
	$.fn.BootSideMenu = function( options ) {
		...
		newCode += "</div>";
		newCode += "<div class=\"toggler toggler-ext\">\n";
		newCode += "	<span class=\"glyphicon glyphicon-chevron-right\"><p>關閉指引</p>&nbsp;</span> <span class=\"glyphicon glyphicon-chevron-left\"><p>開啟指引</p>&nbsp;</span>\n";
		newCode += "</div>\n";
