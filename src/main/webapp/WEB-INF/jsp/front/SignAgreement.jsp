...
<script type="text/javascript" src="<c:url value='/res/js/seeweb/SignAgreement.js' />"></script>
...
<p class="text-right">P-V4-IDEAS</p>
...
<form role="form" class="form-horizontal" id="signAgreementForm" name="signAgreementForm">
	<input type="hidden" id="account" name="account" value="${account}" /> 
	<input type="hidden" id="agreementVersion" name="agreementVersion" value="P-V4-IDEAS" /> 
