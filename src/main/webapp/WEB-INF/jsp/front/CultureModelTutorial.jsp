...
<div class="well well-lg">塑模指引 - 文化模型</div>
<div class="panel panel-default margin-top-lg">
	<div class="panel-body">
		<img id="tuturialFigure" src="<c:url value='/res/images/CultureModelTutorial001.png' />" style="width:100%; height:auto" />
	</div>
	<div class="panel-footer text-center">
		<button type="button" class="btn btn-default" id="prevBtn" name="prevBtn"><i class="fa fa-caret-left"></i></button>
		 第 <span id="currentPage">1</span> / <span id="totalPage">6</span> 頁 
