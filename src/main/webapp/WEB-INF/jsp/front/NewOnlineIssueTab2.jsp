...
<div class="row margin-bottom-lg">			
	<div class="col-md-1 col-sm-1 col-xs-1 text-right">
		<button type="button" id="newFigureBtn" name="newFigureBtn" class="btn btn-success" onclick="addFigure()"><i class="fa fa-plus"></i></button>
	</div>	
</div>

<div class="row" id="dummyFigureDiv">	
</div>
