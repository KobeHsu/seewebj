...
<script type="text/javascript" src="<c:url value='/res/js/seeweb/ProjectWizard.js' />"></script>


<div class="panel panel-default panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">專案階段及工具設定</h3>
  </div>
    ...
    <div class="btn-group margin-bottom-lg" role="group" aria-label="..." id="functionBtnGroup">
		...
		<div role="tabpanel">
  		...
  		<ul class="nav nav-tabs" role="tablist">
    		<li role="presentation" class="active"><a href="#queryPanel" aria-controls="query" role="tab" data-toggle="tab">專案階段清單</a></li>
    		<li role="presentation"><a href="#editPanel1" aria-controls="edit" role="tab" data-toggle="tab">專案階段工具設定</a></li>
  		</ul>

  		<div class="tab-content">
    		<div role="tabpanel" class="tab-pane active" id="queryPanel">
    			<c:import url="/WEB-INF/jsp/front/ProjectWizardQuery.jsp" />
    		</div>
    		<div role="tabpanel" class="tab-pane" id="editPanel1">
    			<c:import url="/WEB-INF/jsp/front/ProjectWizardEditPart1.jsp" />
    		</div>
  		</div>
