...
<script type="text/javascript" src="<c:url value='/res/js/seeweb/OnlineIssueManagement.js' />"></script>

<div class="panel panel-default panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">線上反映問題管理</h3>
  </div>
    ...
    <div class="btn-group margin-bottom-lg" role="group" aria-label="..." id="functionBtnGroup">
		...
		<div role="tabpanel">
  		...
  		<ul class="nav nav-tabs" role="tablist">
    		...
    		<li role="presentation"><a href="#editPanel1" aria-controls="edit" role="tab" data-toggle="tab">線上反映問題</a></li>
  		</ul>

  		<div class="tab-content">
    		<div role="tabpanel" class="tab-pane active" id="queryPanel">
    			<c:import url="/WEB-INF/jsp/front/administration/OnlineIssueManagementQuery.jsp" />
    		</div>
    		<div role="tabpanel" class="tab-pane" id="editPanel1">
    			<c:import url="/WEB-INF/jsp/front/administration/OnlineIssueManagementEditPart1.jsp" />
    		</div>
  		</div>
